const BetterKbinOptions = document.getElementById('textBetterKbinOptions');
...
function translate() {
    browser.storage.local.get(
        ...
        (items) => {
            if (items.language == 1) {
                BetterKbinOptions.innerText = "Options - Better /kbin";
            ...
            if (items.language == 2) {
                BetterKbinOptions.innerText = "Opcje - Better /kbin";
